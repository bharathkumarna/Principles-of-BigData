    ...
    val choice=readInt()
      choice match {
        ...
        case 1 =>
          ...
          Query1.write.json("C:\\Users\\bn4n5\\workspace\\Pb-ass\\mypackage\\Query1")
          Query1.show()
        ...
        case 2 =>
          ...
          Query2.write.json("C:\\Users\\bn4n5\\workspace\\Pb-ass\\mypackage\\Query2")
          Query2.show()
          println("Press Y to continue or N to exit:")
          a = readChar()
        ...
        case 3 =>
          ...
          Query3.write.json("C:\\Users\\bn4n5\\workspace\\Pb-ass\\mypackage\\Query3")
          Query3.show();
          println("Press Y to continue or N to exit:")
          a = readChar()
        ...
        case 4 =>
          ...
          Query4.write.json("C:\\Users\\bn4n5\\workspace\\Pb-ass\\mypackage\\Query4")
          Query4.show()
          println("Press Y to continue or N to exit:")
          a = readChar()
        ...
        case 5 =>
          ...
          Query5.write.json("C:\\Users\\bn4n5\\workspace\\Pb-ass\\mypackage\\Query5")
          Query5.show()
          println("Press Y to continue or N to exit:")
          a = readChar()
